...
export class MultiUserComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    console.log("name of selected friend is: ", this.friendName);
    console.log("userId of selcted friend is:", this.friendId);
    console.log("authToken of logged in user is:", this.authToken)
    console.log("userId of logged in user is:", this.userId)
    console.log("fullName of logged in user is:", this.userName)
    console.log("userInfo of logged in user is:", this.userInfo)
  ...
  public getAllList: any = () => {
    if (this.friendId && this.authToken) {
      let data = {
